use super::{
    expected_section_data::ExpectedSectionData, raw_tasks_tree::RawTasksTree, section::Section,
...
impl From<Vec<ExpectedTechnologyData>> for RawTasksTree {
...
mod tests {
    ...
    fn from_expected_technology_data() {
        ...
        let raw_tasks_tree = RawTasksTree::from(expected);
